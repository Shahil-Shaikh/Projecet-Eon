...
def main(args=None):
    # The previous approach used parser.parse_args(), which caused launch failures
    # when ROS 2 injected its own arguments such as --ros-args during `ros2 launch`.
    # Using parse_known_args() keeps support for the node's own --cfg option while
    # safely ignoring ROS 2 launch flags, solving the issue instantly.
